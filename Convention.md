...
- **이유**
    ...
    2. **작업 담당자** 스스로가 자신의 작업에 대한 이해도를 높이기 위해
...
| doc | 프로젝트 자체에 대한 Document(GitHub 혹은 XCode 상에서) etc Commentary 추가 |
| asset | 프로젝트에서 사용되는 에셋 etc 데이터 추가 |
| build | 작업 환경 세팅과 관련된 사항들을 추가 및 삭제 ETC |
---
### Branch
...
<aside>
💡 [#이슈번호] 작업 태그: 작업 내용 VS [작업태그] 작업 내용 (#이슈번호)
ex) [#14] feat: 회원탈퇴 기능 추가 VS [feat] 회원 탈퇴 기능 추가 (#14)

</aside>

| Commit 작업태그 | Description |
| --- | --- |
| feat | 코드 추가 (UI 관련 Component 추가 포함) |
| fix | 코드 수정, 오타 수정 |
